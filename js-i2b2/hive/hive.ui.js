...
Splitter = function( name, config )
{
	...
	this.resizeOtherComponents = function()
	{
		...
		i2b2.CRC.view.QM.splitterDragged();			// resize Query Main
        i2b2.CRC.view.QT.splitterDragged();			// resize Query Tool
        i2b2.CRC.view.dataSet.splitterDragged();	// resize Data Set
	...
	this.resizeComopnentHeight = function()
	{
        ...
        i2b2.CRC.view.QM.ResizeHeight();			// resize QM
        i2b2.CRC.view.QT.ResizeHeight();			// resize QM.QT
		i2b2.CRC.view.dataSet.ResizeHeight();		// resize QM.dataSet
