 ...
 */
console.group('Load & Execute component file: CRC > view > QueryTool');
...
i2b2.CRC.view.QT.visible = false;

i2b2.CRC.view.QT.hideDisplay = function() {
    $('crcQueryToolBox.bodyBox').hide();
}
i2b2.CRC.view.QT.showDisplay = function() {
...
//             break;
//         case "requestDataSet":
//             this.currentTab = 'requestDataSet';
