			...
			switch($obj->dataOption){
				...
				case "Count":
					...
					foreach($results as $result){ // only has 1 result, but need to iterate over DOMNodeList
						$primary_keys[] = [ 'event_id' => (string) $result->event_id,
...
$domain = 'biobankportal';
//$project = 'Biobank_Genomic_Dev';
$crc_uri = 'http://biobankportaldev.partners.org:9090/i2b2/services/QueryToolService/pdorequest';
