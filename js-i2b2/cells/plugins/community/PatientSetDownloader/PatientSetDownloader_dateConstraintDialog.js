...
// ================================================================================================== //
i2b2.PatientSetDownloader.UI.DateConstraint = {
...
// ================================================================================================== //
    ...
    {
        this.conceptObj     = i2b2.PatientSetDownloader.model.concepts[conceptListIndex]; // remember our concept object
        this.conceptIndex   = conceptListIndex;

		// only build the dialog box once
	    if (!i2b2.PatientSetDownloader.UI.ModalDates)
        {
			var handleSubmit = function()
            {
			    var closure_pi = i2b2.PatientSetDownloader.UI.DateConstraint.conceptObj;
				// save the dates
			    if (i2b2.PatientSetDownloader.UI.DateConstraint.doProcessDates(closure_pi))
				    if (this.submit()) // saved and validated, close modal form
                    {
				        i2b2.PatientSetDownloader.model.dirtyResultsData = true; // table is now stale, get a new one
			...
			i2b2.PatientSetDownloader.UI.ModalDates = new YAHOO.widget.SimpleDialog("dateConstraintDialog",
            {
				width: "400px",
				fixedcenter: true,
			...
			i2b2.PatientSetDownloader.UI.ModalDates.render(document.body);
		}
		i2b2.PatientSetDownloader.UI.ModalDates.show();
		// load our panel data				
...
// ================================================================================================== //
	dateSelected: function(eventName, selectedDate) {
	    ...
	    var cScope = i2b2.PatientSetDownloader.UI.DateConstraint;
