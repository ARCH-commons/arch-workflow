...
i2b2.ShrineConnector.demoMode = true;
...
i2b2.ShrineConnector.Init = function (loadedDiv) {
    /*
     ...
     i2b2.ShrineConnector.model.mysite = data;
     i2b2.ShrineConnector.ready = true;
     ...
     i2b2.ShrineConnector.model.sites[data[i].code] = data[i];
     }
     }
     });
     */
    ...
    i2b2.ShrineConnector.setWorkplaceRootIndex(i2b2.PM.model.login_username);
    ...
    jQuery('<div id="crcAlert" style="position: absolute;width: 375px;height: 50px;z-index: 1000;right:' +
        ...
        ' white;border-radius: 10px;"><img src="js-i2b2/cells/plugins/community/ShrineConnector/assets/left.jpg" style="float: left;" />' +
...
i2b2.ShrineConnector.shrineLoadResults = function () {
    ...
    resultsHtml += "<tr class='header'>" +
        "<th style='width:15px;border-top-style:none;padding:0px;'><img src=\"js-i2b2/cells/plugins/community/ShrineConnector/assets/flagged.png\" alt=\"Flagged\" title=\"Flagged\" /></th>" +
    ...
    for (var resultId = 0; resultId < i2b2.ShrineConnector.model.previousQueries.length; resultId++) {
        var query = i2b2.ShrineConnector.model.previousQueries[resultId];
        ...
        var flagIcon = "<img src=\"js-i2b2/cells/plugins/community/ShrineConnector/assets/flagged.png\" alt=\"Flagged for Acton Needed\" title=\"Flagged for Acton Needed\"/>";
        ...
        var ViewButton = '<button id="VwBtn' + query.networkid + '"  type="button" onclick="' + showQuery + '" title="View SHRINE query locally" ' +
            'style="' + i2b2.ShrineConnector.UI.buttonStyle + '">View</button>';
...
i2b2.ShrineConnector.shrineRunQuery = function (ui_row_id, query_master_id, shrine_query_name, shrineQueryNetworkId) {
    ...
    if (i2b2.ShrineConnector.demoMode) {
        document.getElementById(ui_row_id + 'EditTextSpan').innerHTML = '<img src="js-i2b2/cells/plugins/community/ShrineConnector/assets/ajaxicon.gif" align="absmiddle"/> Processing';
        setTimeout(function () {
...
i2b2.ShrineConnector.shrineGetResults = function (max_records, match_str, user_id, shrine_category, type) {
...
i2b2.ShrineConnector.setWorkplaceRootIndex = function (user_id) {
    var scopedCallback = new i2b2_scopedCallback();
